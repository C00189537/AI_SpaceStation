...
void Radar::initialise(sf::Vector2f *playerPos, int _level[HEIGHT][WIDTH])
{
...
void Radar::update()
{
	...
	m_playerTracker.setPosition(sf::Vector2f(4 + trackingPoint->x + (480 / 2) - (WIDTH * 4) + (std::floor(trackingPoint->x / 64) * 4), 
		4 + trackingPoint->y + (360 / 2) - (HEIGHT * 4) + (std::floor(trackingPoint->y / 64) * 4)));
